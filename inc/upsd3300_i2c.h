...
unsigned char upsd_i2c_Master_Xmit (unsigned char Slave_Addr, 
							unsigned char xdata* Data_Ptr,
							unsigned char N);

#ifndef ARM9platform

    unsigned char upsd_i2c_Master_Xmit_nowait (unsigned char Slave_Addr, 
                                unsigned char xdata* Data_Ptr,
                                unsigned char N) using 1;
#else
    unsigned char upsd_i2c_Master_Xmit_nowait (unsigned char Slave_Addr, 
                                unsigned char xdata* Data_Ptr,
                                unsigned char N);
...
I2C_BUSLOST		14			//I2C bus lost
-------------------------------------------------------------------------*/
unsigned char upsd_i2c_slave_Xmit(unsigned char xdata* Data_Ptr,
									unsigned char xdata* N_Ptr);
...
-------------------------------------------------------------------------*/
unsigned char upsd_i2c_slave_Recv(unsigned char xdata* Data_Ptr,
									unsigned char xdata* N_Ptr);
