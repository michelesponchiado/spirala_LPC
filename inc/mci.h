...
// frequenza di clock da usare nelle fasi di inizializzazione
#define MCLKDIV_SLOW_HZ		400000
// frequenza di clock da usare a regime
#define MCLKDIV_NORMAL_HZ	12000000

/* MCI clk freq = Pclk/(2* (Clkdiv +1) */
#define MCLKDIV_SLOW		(Fcclk/(2*MCLKDIV_SLOW_HZ)-1) /* 59 = 400,000Hz -> @48Mhz/(2*60) */ 
#define MCLKDIV_NORMAL		(Fcclk/(2*MCLKDIV_NORMAL_HZ)-1)  
...
extern DWORD MCI_Send_Write_Multiple_Block(DWORD blockNum);
