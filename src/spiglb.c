...
= {
   {
     ...
     {1.0,1.0},           /* Assorbimento delle frizioni in amp�re. */
...
/* Taratura dei canali analogici. Non � unica per ogni canale,
   ma ne esiste una per ogni portata.
   Per ora � prevista la taratura dei soli canali 0 (misura dinamica)
   ed 1 (misura statica).
*/
