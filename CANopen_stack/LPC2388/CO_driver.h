...
/*******************************************************************************
   ...
   ADDR_CAN1      - selects CAN module 1. Constant has a value 0.
   ADDR_CAN2      - selects CAN module 2. Constant has a value 1.
*******************************************************************************/
#define ADDR_CAN1    enum_LPC_CAN_Port_1
#define ADDR_CAN2    enum_LPC_CAN_Port_2
...
// lpc2388 is little endian (pag 8/707 dello user manual lpc2388)
#undef BIG_ENDIAN
